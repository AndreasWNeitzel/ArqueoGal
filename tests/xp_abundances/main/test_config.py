...
def test_training_config_field_set_is_recorded() -> None:
    ...
    expected_subset = {
        "train_parquet", "output_dir",
        "latent_dim", "trunk_hidden", "head_hidden", "dropout",
        "max_lr", "weight_decay", "pct_start", "grad_clip_norm",
        "epochs", "batch_size", "num_workers", "amp_dtype",
        "loss_weights", "temperature_init", "temperature_bounds",
        "split_seed", "fracs",
        "ensemble_seeds",
        "early_stop_patience", "early_stop_min_delta",
        "deterministic",
        "use_c0_scalars", "encoder_lr_ratio",
        "checkpoint_every_n_epochs", "pretrained_encoder_ckpt",
        "relative_min_delta", "output_prefix",
        "reload_head_from_pretrained", "first_epoch_sanity_k",
        "stage_dataset_on_gpu",
        "queue_size", "queue_warm_start",
        "grad_norm_abort_threshold",
        "inverse_freq_weighting", "inverse_freq_mh_column",
        "inverse_freq_bin_edges", "inverse_freq_clip",
    }
